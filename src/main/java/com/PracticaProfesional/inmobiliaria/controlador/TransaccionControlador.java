...
public class TransaccionControlador {
    ...
    public ResponseEntity<Map<String, Object>> nuevaTransaccion(@RequestBody Transaccion transaccion,
            @RequestParam Usuario usuario, @RequestParam String tipoOperacion,
            @RequestParam String descripcion, @RequestParam BigDecimal importe,
            @RequestParam String tipoTransaccion) {
        try {
            
            inicializarTransaccion(transaccion, usuario, tipoOperacion, descripcion, importe, tipoTransaccion);
    ...
    private void inicializarTransaccion(Transaccion transaccion, Usuario usuario, String tipoOperacion, String descripcion, BigDecimal importe, String tipoTransaccion) {
        transaccion.setIdAgente(usuario);
