...
public interface ContratoInterfaceRepo extends JpaRepository<Contrato, Integer> {
    ...
    public List<Contrato> filtrarContratos(boolean activo, EnumEstadoContrato estado, Date fechaDesde, Date fechaHasta, Integer cliente, EnumTipoContrato tipoContrato);
}
